...
public class ModConfig implements ConfigData, ConfiguresRotation {
    ...
    public static void init() {
        ...
        ModLoadingContext.get().registerExtensionPoint(ConfigScreenHandler.ConfigScreenFactory.class, () -> new ConfigScreenHandler.ConfigScreenFactory((minecraft, parent) -> AutoConfig.getConfigScreen(ModConfig.class, parent).get()));
    }
